...
class VideoDetail extends StatefulWidget {
  ...
  const VideoDetail({super.key, required this.detail});
        ...
        Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              _buildButtonColumn(Icons.share, "مشاركة"),
              _buildButtonColumn(Icons.cloud_download, "تنزيل"),
              _buildButtonColumn(Icons.playlist_add, "حفظ"),
            ],
          ),
        )
      ],
